    ...
    <div
                    ...
                    <div class="items-center flex">
                        <span
                            class="w-12 h-12 text-sm text-white bg-slate-200 inline-flex items-center justify-center rounded-full"><img
                                ...
                                src="https://eu.ui-avatars.com/api/?name={{ urlencode(auth()->user()->name) }}"/></span>
                    </div>
                </a>
                <div
        ...
        <div
            ...
            <ul class="md:flex-col md:min-w-full flex flex-col list-none">
                ...
                @can('manage-students')
                    ...
                    <li class="items-center">
                        <x-nav-link href="{{ route('students.index') }}"
                                    :active="request()->routeIs('students.index', 'students.create', 'students.edit', 'students.assign.subject', 'students.assign.mark')">
                            <x-slot name="icon">
                    ...
                    <li class="items-center">
                        <x-nav-link href="{{ route('subjects.index') }}"
                                    :active="request()->routeIs('subjects.index', 'subjects.create', 'subjects.edit')">
                            <x-slot name="icon">
                                <i class="fas fa-users mr-2 text-sm opacity-75"></i>
                            </x-slot>
                            {{ __('Subjects') }}
                ...
                @else
                    <li class="items-center">
                        <x-nav-link href="{{ route('student.welcome') }}"
                                    :active="request()->routeIs('student.welcome')">
                            <x-slot name="icon">
                                <i class="fas fa-tv mr-2 text-sm opacity-75"></i>
                            </x-slot>
                            {{ __('Welcome') }}
